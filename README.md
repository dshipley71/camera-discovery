...
```bash
CAMERA_DISCOVERY_TARGET_INTENT_MODEL=gemma3:4b-cloud
CAMERA_DISCOVERY_GEOCODER_REFEREE_MODEL=gemma3:4b-cloud
CAMERA_DISCOVERY_CANDIDATE_REVIEW_MODEL=gemma3:4b-cloud
